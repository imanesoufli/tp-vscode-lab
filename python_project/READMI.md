...
```powershell
PS C:\Users\ELITE COMPUTER\tp-vscode-lab-1> python -m pytest
====================== test session starts ======================
platform win32 -- Python 3.14.4, pytest-9.0.3, pluggy-1.6.0
rootdir: C:\Users\ELITE COMPUTER\tp-vscode-lab-1
collected 2 items                                                

python_project\test_factorial.py F                         [ 50%]
python_project\test_main.py .                              [100%]
...
python_project\test_factorial.py:5: AssertionError
==================== short test summary info ==================== 
FAILED python_project/test_factorial.py::test_factorial - assert 2 == 1
